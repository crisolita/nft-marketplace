...
describe("NFT1155", () => {
  ...
  it("Should create 1 unit NFT", async () => {
    ...
    await nft1155.mintNew(1, 10,"my content","nft-hash-1",{from: admin.address});
  ...
  it("Should create 10 units of NFTs", async () => {
    ...
    await nft1155.mintNew(10, 10, "my content", "nft-hash-2",{from: admin.address});
  ...
  it("Should create 10 units of 2 types of NFTs", async () => {
    ...
    await nft1155.mintNew(10, 10, "my content", "nft-hash-3",{from: admin.address});
