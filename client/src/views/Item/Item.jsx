          ...
          <div className="item-container row p-3">
            <Col sm={5}>
              <div className="my-3 mx-auto" style={{width: '80%', height: '40vh'}}>
                ...
                <p>You own: {amountOwn}</p>
                {isItemOwner && 
                  <div>
                    Only owner content: {ownerContent}
                  </div>
                }
              </div>
            </Col>
              ...
              <div className="w-75 mt-3 item-card p-3">
                ...
                {sellOffers?.map((element, key) => (
                  <Row key={key} className="p-0 m-0 py-2" style={{borderTop: '1px solid lightgrey'}}>
                    <Col sm={4} className='super-center'>{(element.price/element.amount).toFixed(3)}</Col>
                    <Col sm={3} className='super-center'>{element.amount}</Col>
                    <Col sm={4} className='super-center'>{element.price}</Col>
                    <Col sm={1} className='super-center'>
                      {(!account || element.seller.toLowerCase() !== account.toLowerCase()) && 
